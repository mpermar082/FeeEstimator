...
#[derive(Debug)]
pub struct FeeEstimatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FeeEstimatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FeeEstimator processing");
    
    let mut processor = FeeEstimatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FeeEstimatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FeeEstimatorProcessor::new(false);
